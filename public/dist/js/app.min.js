!function(){"use strict";angular.module("cv",["ui.router","ui.bootstrap","ngAnimate","ngToast","ngSanitize","naif.base64"]).run(["$rootScope","$window","$currentUser","$baseUrl","$cvId","$state","ngToast",function(t,e,o,r,i,l,n){e.location.href===r?o?l.go("edit",{},{location:!1}):l.go("home",{},{location:!1}):i&&l.go("view",{},{location:!1}),t.$on("notifyUser",function(t,e){n.create({content:e,timeout:2e3})})}]).config(["$stateProvider","$urlRouterProvider","$animateProvider","$baseUrl",function(t,e,o,r){t.state("home",{url:"/home",templateUrl:r+"/dist/templates/welcome.html",controller:"AppCtrl"}).state("edit",{url:"/edit",templateUrl:r+"dist/templates/cv/edit/edit.html",controller:"EditController"}).state("view",{url:"/view",templateUrl:r+"dist/templates/cv/view.html",controller:["$scope","$cvId",function(t,e){t.cvId=e}]})}]).controller("AppCtrl",["$scope",function(t){t.welcome="CV online Builder"}])}();
