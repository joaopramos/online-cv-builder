!function(){"use strict";angular.module("cv",["ui.router","ui.bootstrap","ngAnimate","ngToast","ngSanitize","naif.base64"]).factory("sessionInterceptor",["$baseUrl",function(t){return{responseError:function(e){401===e.status&&(window.location=t+"auth/login")}}}]).run(["$rootScope","$window","$currentUser","$baseUrl","$cvId","$state","ngToast",function(t,e,o,r,n,i,l){e.location.href===r?o?i.go("edit",{},{location:!1}):i.go("home",{},{location:!1}):n&&i.go("view",{},{location:!1}),t.$on("notifyUser",function(t,e){l.create({content:e,timeout:2e3})}),t.$on("loginRequired",function(t){})}]).config(["$stateProvider","$urlRouterProvider","$animateProvider","$baseUrl","$injector","$httpProvider",function(t,e,o,r,n,i){i.interceptors.push("sessionInterceptor"),t.state("home",{url:"/home",templateUrl:r+"/dist/templates/welcome.html",controller:"AppCtrl"}).state("edit",{url:"/edit",templateUrl:r+"dist/templates/cv/edit/edit.html",controller:"EditController"}).state("view",{url:"/view",templateUrl:r+"dist/templates/cv/view.html",controller:["$scope","$cvId",function(t,e){t.cvId=e}]})}]).controller("AppCtrl",["$scope",function(t){t.welcome="CV online Builder"}])}();
...
!function(){"use strict";angular.module("cv").controller("ElementController",["$scope","cvFactory","$timeout",function(e,t,n){"true"===e.init&&(e.element=e.$parent.$parent.cv.element),e.onBlur=function(t){e.element.changed&&(e.element.changed=!1,e.element.update())},e.destroy=function(){e.element.destroy()},e.removeProfilePic=function(){e.element.data.profilepic=null,e.element.update()}}])}();
!function(){"use strict";angular.module("cv").directive("cvElement",["$baseUrl",function(e){return{restrict:"E",controller:"ElementController",controllerAs:"element",scope:{element:"=",init:"@"},templateUrl:e+"dist/templates/cv/edit/cvElement.html"}}])}();
!function(){"use strict";angular.module("cv").controller("EditController",["$scope","$anchorScroll","$cvId","$http",function(e,n,t,u){function o(){u.get("templates").then(function(n){e.templates=n.data})}e.cvId=t,e.sideMenu={show:!1,menu:""},e.templates=[],o(),e.openMenu=function(t){e.sideMenu.menu===t?(e.sideMenu.show=!1,e.sideMenu.menu=""):(e.sideMenu.menu=t,e.sideMenu.show=!0,n("top"))}}])}();